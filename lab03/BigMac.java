...
//This program calculates the cost of buying some Big Macs. It uses the Scanner
//class to obtain from the user how many Big Macs, the cost per Big Mac, and 
//the percentage tax (which depends on the state) and then displays the total 
//cost. 
